...
Pipe reads never align to box boundaries: a single read() can return a
partial header, a partial payload split across many reads, or several
complete boxes concatenated together. BoxReader buffers bytes until whole
boxes are available.
"""
